...
const TorchGlow = ({ className }: { className?: string }) => (
  <div
    className={`absolute pointer-events-none select-none z-10 hidden md:block ${className}`}
...
const Torch = ({ className }: { className?: string }) => (
  <div
    className={`absolute pointer-events-none select-none z-30 hidden md:block ${className}`}
  >
    <div className="relative w-[30px] h-[80px]">
      ...
      >
        ...
        <motion.ellipse
          ...
          fill="#FFF3C0"
          animate={{
            scaleY: [1, 1.25, 0.82, 1.15, 1],
            opacity: [0.78, 1, 0.72, 0.92, 0.78],
          }}
        ...
        <path
          d="M 8,50 H 22 M 8,47 V 53 M 22,47 V 53"
          stroke="#3D3025"
          strokeWidth="1.5"
        />
      ...
      <div
        className="absolute w-1 h-1 rounded-full bg-[#FFAA50] animate-torch-ember-0"
        style={{ left: "14px", bottom: "45px" }}
      />
      <div
        className="absolute w-1 h-1 rounded-full bg-[#FFAA50] animate-torch-ember-1"
        style={{ left: "14px", bottom: "45px" }}
      />
      <div
        className="absolute w-1 h-1 rounded-full bg-[#FFAA50] animate-torch-ember-2"
        style={{ left: "14px", bottom: "45px" }}
      />
      <div
        className="absolute w-1 h-1 rounded-full bg-[#FFAA50] animate-torch-ember-3"
        style={{ left: "14px", bottom: "45px" }}
      />
    </div>
  </div>
...
export default function About() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(to bottom, #17110D 0%, #1B120D 30%, #21160E 70%, #26180F 100%)",
      }}
    >
      <TorchStyles />
      ...
      <div className="absolute top-0 inset-x-0 h-32 pointer-events-none z-0">
        <svg
          className="w-full h-full text-[#100C09]"
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, transparent 30%, rgba(10, 7, 5, 0.9) 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at top center, rgba(225, 138, 66, 0.12) 0%, rgba(225, 138, 66, 0.03) 50%, transparent 80%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(225, 138, 66, 0.05) 0%, rgba(139, 90, 43, 0.02) 60%, transparent 100%)",
        }}
      />
      ...
      >
        {/* Main Vine Stem */}
        <path
          d="M 15,0 C 30,80 5,160 20,240 C 35,320 15,380 25,440"
          stroke="#1C5A13"
          strokeWidth="3.0"
          fill="none"
          strokeLinecap="round"
        ...
        {/* Sub-branch 1 */}
        <path
          d="M 17,120 C 35,140 40,180 23,210"
          stroke="#1C5A13"
          strokeWidth="1.8"
          fill="none"
          strokeLinecap="round"
        ...
        {/* Sub-branch 2 */}
        <path
          d="M 22,260 C 38,280 36,320 20,350"
          stroke="#1C5A13"
          strokeWidth="1.8"
          fill="none"
          strokeLinecap="round"
      ...
      >
        {/* Main Vine Stem */}
        <path
          d="M 75,0 C 60,80 85,160 70,240 C 55,320 75,380 65,440"
          stroke="#1C5A13"
          strokeWidth="3.0"
          fill="none"
          strokeLinecap="round"
        ...
        {/* Sub-branch 1 */}
        <path
          d="M 73,120 C 55,140 50,180 67,210"
          stroke="#1C5A13"
          strokeWidth="1.8"
          fill="none"
          strokeLinecap="round"
        ...
        {/* Sub-branch 2 */}
        <path
          d="M 68,260 C 52,280 54,320 70,350"
          stroke="#1C5A13"
          strokeWidth="1.8"
          fill="none"
          strokeLinecap="round"
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(255,120,40,0.06) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-[1200px] w-full mx-auto z-40 relative">
        ...
        >
          ...
          <p className="font-sans text-[16px] md:text-[18px] leading-[1.6] text-[rgba(245,241,235,0.78)] font-light max-w-[600px] mx-auto">
            Crafting scalable systems, intelligent products, and meaningful
            digital experiences.
          </p>
        </motion.div>
        ...
        <div className="relative max-w-[1050px] mx-auto">
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow:
                "0 20px 80px rgba(0,0,0,0.4), 0 0 60px rgba(255,120,40,0.04)",
            }}
          >
            <motion.div
            ...
            >
                ...
                <div className="flex flex-col justify-between h-full p-6 md:p-8 rounded-2xl border border-[rgba(255,170,80,0.06)] bg-[rgba(255,255,255,0.01)] relative overflow-hidden">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-1">
                      <span className="font-mono text-[10px] text-[#FFAA50]/60 tracking-[0.2em] uppercase">
                        IDENTITY PLAQUE
                      </span>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-xs font-mono">
                      <div>
                        <span className="text-[#C9B7A4]/40 block uppercase tracking-wider text-[9px]">
                          EDUCATION
                        </span>
                        <span className="text-[#F5F1EB] font-medium block mt-1">
                          CBIT Hyderabad
                        </span>
                      </div>
                      <div>
                  ...
                  <div className="mt-8 border-t border-[rgba(255,170,80,0.08)] pt-5">
                    <span className="text-[#C9B7A4]/40 font-mono text-[9px] block uppercase tracking-wider mb-2">
                      PERSONAL MISSION
                    </span>
                    <p className="font-sans text-sm text-[rgba(245,241,235,0.78)] font-light leading-relaxed italic">
                      "Building software that transforms ideas into scalable
                      systems."
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="space-y-6">
                  ...
                  <div
                    className="pb-5"
                    style={{ borderBottom: "1px solid rgba(255,170,80,0.08)" }}
                  >
                    ...
                    <div className="font-sans text-[16px] leading-[1.8] text-[rgba(245,241,235,0.78)] font-light mt-4">
                      <p>
                        Hi, I'm Dhanush, a Computer Science student at CBIT
                        Hyderabad specializing in frontend and backend systems.
                        I engineer high-performance web applications, focusing
                        on scalable architecture, clean code, and cloud
                        computing pipelines. My journey revolves around{" "}
                        <span className="underline decoration-[#E18A42] underline-offset-4 decoration-1 font-medium">
                          solving complex algorithmic challenges
                        </span>
                        , building production-grade sites, and experimenting
                ...
                {/* Bottom Motto Footer */}
                <div
                  className="pt-5 mt-6 flex flex-col items-center"
                  style={{ borderTop: "1px solid rgba(255,170,80,0.08)" }}
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-stretch justify-center">
            {[
              ...
              },
              {
                ...
                desc: "Whiteboard Sync Project",
              },
              {
                badge: "💻",
                title: "200+ LeetCode Problems",
                desc: "Algorithmic Ascent",
              },
              {
                badge: "🎯",
                title: "9.60 CGPA CSE",
                desc: "CBIT Batch Distinction",
              },
            ].map((ach, idx) => (
              <div
                key={idx}
              ...
              >
                <span className="text-2xl mb-2 filter drop-shadow-[0_0_8px_rgba(255,170,80,0.25)]">
                  {ach.badge}
                </span>
                <h4 className="font-sans text-xs font-semibold text-[#F5F1EB]">
                  {ach.title}
                </h4>
                <span className="font-mono text-[9px] text-[#C9B7A4]/50 uppercase tracking-wider mt-1 block">
                  {ach.desc}
                </span>
              </div>
            ))}
